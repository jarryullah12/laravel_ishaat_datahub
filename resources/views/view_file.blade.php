        ...
        <div class="container-fluid">
            <div class="content-container">
                ...
                <div class="page-header">
                    <h1 class="page-title">دفتر فائل فہرست</h1>
                </div>
                ...
                <div class="table-section">
                        ...
                        <table class="table table-bordered table-hover" class="myTable" id="myTable">
                            <thead>
                                <tr>
                                    <th>سیریل نمبر</th>
                                    <th>تاریخ</th>
                                    <th>فائل کا نام/ خلاصہ مضمون</th>
                                    <th>فائل (ورڈ/ پی ڈی ایف)</th>
                                    <th>ایڈٹ</th>
                                </tr>
                            </thead>
                    ...
                    <tr>
                        ...
                        <td> <a href="{{ ('public/storage/' . $file->file) }}" download>ڈاوٌن لوڈ فائل</a></td>
                        <td><a class="btn btn-sm btn-success" href={{"edit_file/".$file['id']}}><i class="fas fa-edit"></i></a>
                        <a class="btn btn-sm btn-danger" href={{"delete_file/".$file['id']}}><i class="fas fa-trash"></i></a></td>
