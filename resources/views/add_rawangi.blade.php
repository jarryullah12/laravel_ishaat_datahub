        ...
        <div class="container">
            <div class="content-container">
                ...
                <div class="page-header">
                    <h1 class="page-title">ڈاک روانگی اندراج </h1>
                </div>
                
                <!-- Data Entry Form -->
                <div class="form-section">
                    <h4><i class="fas fa-edit ml-2"></i>معلومات</h4>
                    <form id="dataForm" enctype="multipart/form-data" action="add_rawangi" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="rawangi_no" class="form-control" id="location" placeholder="روانگی نمبر درج کریں" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" id="location" placeholder="کس کے نام ہے درج کریں" required>
