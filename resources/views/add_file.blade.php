        ...
        <div class="container">
            <div class="content-container">
                ...
                <div class="page-header">
                    <h1 class="page-title"> دفتر فائل اندراج </h1>
                </div>
                
                <!-- Data Entry Form -->
                <div class="form-section">
                    <h4><i class="fas fa-edit ml-2"></i>معلومات</h4>
                    <form id="dataForm" action="add_file" method="POST" enctype="multipart/form-data" >
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">فائل کا نام/ خلاصہ مضمون</label>
                                    <input type="text" name="file_name" class="form-control" id="location" placeholder="فائل کا نام / خلاصہ مضمون درج کریں" required>
                                </div>
                            </div>
                        </div>
                         <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-label">فائل (ورڑ/ پی ڈی ایف)</label>
