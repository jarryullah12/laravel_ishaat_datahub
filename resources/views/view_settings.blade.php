        ...
        <div class="container-fluid">
            <div class="content-container">
                ...
                <div class="page-header">
                    <h1 class="page-title">پروفائل سیٹنگ فہرست</h1>
                </div>
                ...
                <div class="table-section">
                    ...
                    <tr>
                       ...
                       <td>{{ $setting->name }}</td>
                        ...
                        <td><a class="btn btn-sm btn-success" href={{"edit_pro/".$setting['id']}}><i class="fas fa-edit"></i></a>
                        <a class="btn btn-sm btn-danger" href={{"delete/".$setting['id']}}><i class="fas fa-trash"></i></a></td> 
