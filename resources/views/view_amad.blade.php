        ...
        <div class="container-fluid">
            <div class="content-container">
                ...
                <div class="page-header">
                    <h1 class="page-title">ڈاک آمد فہرست</h1>
                </div>
                ...
                <div class="table-section">
                    ...
                    <tr>
                        ...
                        <td>{{$amad['name']}}</td>
                        <td>{{$amad['detail']}}</td>
                        <td><img class="popup-img"  src="{{ ('public/storage/'.$amad->file) }}"  alt="{{ $amad->file }}"  style="cursor:pointer; width:70px;"></td>
                        <td><a class="btn btn-sm btn-success" href={{"edit_amad/".$amad['id']}}><i class="fas fa-edit"></i></a>
                        <a class="btn btn-sm btn-danger" href={{"delete_amad/".$amad['id']}}><i class="fas fa-trash"></i></a></td>
